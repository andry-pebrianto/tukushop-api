...
const { addProduct, listProduct, newProduct, disableProduct, listMyProduct, detailProduct, removeProductPhoto, editProduct, listProductByCategory } = require("../controllers/product.controller");
